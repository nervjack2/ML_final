...
sample_submission_fpath = sys.argv[3]
submission_fpath = sys.argv[4]
...
submission = pd.read_csv(sample_submission_fpath)
...
mp = os.path.join(model_dir, 'model.h5')
...
submission.to_csv(submission_fpath, index=False)
